    ...
    <div class="row p-t-30">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dt-button" id="tbl_users">
                    <thead>
...
@section('scripts')
    ...
    {{-- <script src="{{asset('DataTables/Buttons-2.3.4/js/buttons.dataTables.min.js')}}"></script> --}}
    {{-- <script src="{{asset('dataTable/js/buttons.html5.min.js')}}"></script> --}}
    {{-- <script src="{{asset('dataTable/js/buttons.print.min.js')}}"></script> --}}
    {{-- <script src="{{asset('dataTable/js/jszip.min.js')}}"></script> --}}
    {{-- <script src="{{asset('dataTable/js/pdfmake.min.js')}}"></script> --}}
    {{-- <script src="{{asset('dataTable/js/vfs_fonts.js')}}"></script> --}}
    {{-- <script src="{{asset('dataTable/js/moment.js')}}"></script> --}}
